import {FormControlErrorIcon, FormControlErrorText} from '@/components/ui/form-control';
...
import CreateProgramRequest, {ProgramCreateValidation} from '@/src/models/program/ProgramCreateRequest';
...
import {setCreatedProgram} from '@/src/redux/reducers/StatesCreateProgram';

export default function FormProgramCreate() {
  ...
  const formik = useFormik({
    ...
    validationSchema: ProgramCreateValidation,
    onSubmit: async values => {
      try {
        ...
        dispatch(setCreatedProgram(createdProgram));
      } finally {
        setIsPending(false);
      }
    },
